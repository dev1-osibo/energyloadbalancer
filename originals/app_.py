...
energy_color = "green" if energy_savings > 0 else "red"
energy_arrow = "??" if energy_savings > 0 else "??"
col1.metric(
...
cost_color = "green" if cost_savings > 0 else "red"
cost_arrow = "??" if cost_savings > 0 else "??"
col2.metric(
    "Optimized Cost ($)", 
...
emissions_color = "green" if emissions_savings > 0 else "red"
emissions_arrow = "??" if emissions_savings > 0 else "??"
col3.metric(
