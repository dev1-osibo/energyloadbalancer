...
# Renewable energy availability threshold slider
...
energy_delta_color = "normal" if energy_savings > 0 else "inverse"
col1.metric(
    ...
    delta_color=energy_delta_color
)

# Cost Savings
cost_savings = simulation_results['cost_savings']
cost_arrow = "⬇️" if cost_savings > 0 else "⬆️"
cost_delta_color = "normal" if cost_savings > 0 else "inverse"
col2.metric(
    "Optimized Cost ($)", 
...
col3.metric(
    ...
    delta_color=emissions_delta_color
)
